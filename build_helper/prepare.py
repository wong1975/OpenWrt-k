# OpenWrt 源码仓库 URL ：在208行 pygit2.clone_repository
...
def prepare(configs: dict[str, dict[str, Any]]) -> None:
    ...
    to_clone: set[tuple[str, str]] = {("https://github.com/immortalwrt/packages", ""),
                                       ...
                                       ("https://github.com/NueXini/NueXini_Packages/tree/main/luci-app-mosdns", ""),
    ...
    #pygit2.clone_repository("https://github.com/wong1975/My_OpenWrt", os.path.join(openwrt_paths, cfg_names[0]))
...
def prepare_cfg(config: dict[str, Any],
    ...
    shutil.copytree(cloned_repos[("https://github.com/QiuSimons/openwrt-mos/trunk/luci-app-mosdns", "master")],
                    os.path.join(openwrt.path, "feeds", "luci", "applications", "luci-app-mosdns"), symlinks=True)
    shutil.copytree(cloned_repos[("https://github.com/QiuSimons/openwrt-mos/trunk/mosdns", "master")],
